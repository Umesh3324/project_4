...
public class DataValidator {
	...
	public static boolean isNotNull(String val) {
		System.out.println("isNotNull() in datavalidator, & value is: "+val);
	        return !isNull(val);
	    }
	...
	public static boolean isInteger(String val) {
		System.out.println(" isInteger in dv, & value is : "+val);
	...
	public static boolean isLong(String val) {
		System.out.println("------ isLong in dv & value is: "+val);
	        if (isNotNull(val)) {
	            try {
	...
	public static boolean isEmail(String val) {
		   System.out.println("------ isemail in dv & value is : "+val);
	...
	public static boolean isDate(String val) {
		   System.out.println("------- isdate in dv & value is:  "+val);
	...
	public static boolean isName(String name) {
		System.out.println("-------  isname in DV and value is: "+name);
