...
public class HTMLUtility {
	...
	public static String getList(String name, String selectedVal, HashMap<String, String> map) {
		  ...
		  StringBuffer sb = new StringBuffer("<select style='width: 324px;  height: 28px;' class='form-control' name='" + name + "'>");
	        ...
	        if (select) {
	            ...
	            sb.append("<option style='width: 324px;  height: 28px;' selected value=''>-------------------------"
	            		+ "-Select----------------------------</option>");
	        }
	    ...
	    public static String getList(String name, String selectedVal, List list) {
	        ...
	        if (select)
	        {
	            ...
	            sb.append("<option style='width: 324px;  height: 28px;' selected value=''>---------------------------Select-----------------------------</option>");
	        }
