...
public class LoginCtl extends BaseCtl {
	...
	protected void doGet(HttpServletRequest request,HttpServletResponse response) throws IOException, ServletException{
		...
		System.out.println(" Object of UserModel and RoleModel Created: *****");
		
		long id=DataUtility.getLong(request.getParameter("id"));
		
		System.out.println("This is Id we get from request.getParameter: "+ id);
	...
	if(OP_SIGN_IN.equalsIgnoreCase(op)){
		System.out.println("Now story starts: ......signin in dopost method of Loginctl");
		...
		try{
			...
			if(bean!=null){
				...
				if (uri== null || "null".equalsIgnoreCase(uri)) {
					System.out.println("uri==null condition and uri is: "+ uri);
					ServletUtility.redirect(ORSView.WELCOME_CTL, request, response);
					return;
				} else {
		
					System.out.println("Else part of Uri null check......and Uri is: "+ uri);
					if (rolebean.getId() == 1) 
					{
						System.out.println("rolebean.getId is: "+rolebean.getId());
