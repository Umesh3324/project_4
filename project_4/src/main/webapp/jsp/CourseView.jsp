...
<%@include file="Header.jsp" %>
	...
	<tr>
		...
		<td style="position: absolute;"><font color="red"> <%=ServletUtility.getErrorMessage("courseName", request)%></font>
		</td>
	</tr>
	...
	<tr>
					...
					<td>
						...
						%> <%=HtmlList%></td>
					<td style="position: absolute;"><font color="red"> <%=ServletUtility.getErrorMessage("duration", request)%></font>
					</td>
