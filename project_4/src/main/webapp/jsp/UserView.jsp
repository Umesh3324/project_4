		...
		<center>
			...
			<table>
				...
				<tr>
					...
					<td style="position: absolute;"><font color="red"> <%=ServletUtility.getErrorMessage("password", request)%></font></td>
				</tr>
				...
				<tr>
					...
					<td><input type="password" name="confirmPassword" class="p2"
						...
						value="<%=DataUtility.getStringData(bean.getPassword())%>"></td>
					<td style="position: absolute;"><font color="red"> <%=ServletUtility.getErrorMessage("confirmPassword", request)%></font></td>
				</tr>
				<%
					}
				%>
				...
				<tr>
					...
					<td style="position: absolute;"><font color="red"> <%=ServletUtility.getErrorMessage("roleId", request)%></font>
					</td>
				</tr>
				<tr>
					...
					<td style="position: absolute;"><font color="red"> <%=ServletUtility.getErrorMessage("dob", request)%></font></td>
