...
<%@include file="Header.jsp" %>
 ...
 <tr>
	...
	<td style="position: absolute;"><font color="red"><%=ServletUtility.getErrorMessage("subjectName", request)%></font></td>
 </tr>
 ...
 <tr>
   ...
   <td><textarea name="description"  placeholder="Enter Description" style="width: 324px;height:50px; resize: none;"><%=DataUtility.getStringData(bean.getDescription())%></textarea></td>
  <td style="position: absolute;"><font color="red"><%=ServletUtility.getErrorMessage("description",request) %></font></td>
   </tr>
