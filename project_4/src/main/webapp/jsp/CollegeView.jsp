...
<td style="position: absolute;"><font color="red"><%=ServletUtility.getErrorMessage("name",request) %></font></td>
   </tr>
   <tr>
     ...
     <td style="position: absolute;"><font color="red"><%=ServletUtility.getErrorMessage("address", request) %></font></td>
     </tr>
     <tr>
     ...
     <td style="position: absolute;"><font color="red"><%=ServletUtility.getErrorMessage("state", request) %></font></td>
     </tr>
     <tr>
     ...
     <td style="position: absolute;"><font color="red"><%=ServletUtility.getErrorMessage("city", request) %></font></td>
     </tr>
     <tr>
     <th align="left" class="p1">PhoneNo<span style="color:red">*</span></th>
     <td> <input type="text" name="phoneNo" maxlength="12" class="p2" size="40" placeholder="Enter PhoneNo" 
     		value="<%=DataUtility.getStringData(bean.getPhoneNo()) %>"></td>
     <td style="position: absolute;"><font color="red"><%=ServletUtility.getErrorMessage("phoneNo", request) %></font></td>
     </tr>
