...
<body>
   ...
   <table>
     <tr>
        ...
        <td style="position: absolute;"><font color="red"><%=ServletUtility.getErrorMessage("rollNo", request) %></font></td> 
     </tr>
     <tr>
       ...
       <td style="position: absolute;"><font color="red"> <%=ServletUtility.getErrorMessage("studentId", request)%></font></td>
       </tr>
       ...
       <tr>
         ...
         <td style="position: absolute;"><font color="red"><%=ServletUtility.getErrorMessage("physics", request) %></font>
         </td></tr>
         <tr>
         ...
         <td style="position: absolute;"><font color="red"><%=ServletUtility.getErrorMessage("chemistry", request) %></font>
         </td></tr>
         <tr>
         ...
         <td style="position: absolute;"><font color="red"><%=ServletUtility.getErrorMessage("maths", request) %></font>
         </td></tr>
         <%
					if (bean.getId() > 0) {
		 %>
