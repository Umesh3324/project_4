...
<body>
	...
	<tr>
		<td align="center">
		<label class="p1"> FirstName :</label> <input type="text" placeholder="Enter First Name" name="firstName" class="p2"
		value="<%=ServletUtility.getParameter("firstName", request)%>">&emsp;&emsp;
						&emsp;&emsp;
		<label class="p1">Email_Id :</label> <input type="text" name="email" placeholder="Enter Email id" class="p2"
