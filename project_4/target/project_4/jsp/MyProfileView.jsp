  ...
  <td style="position: absolute;">  <font color="red"><%=ServletUtility.getErrorMessage("lastName", request) %></font></td>
    ...
    <%-- <tr>
      ...
      <td>
		...
		<td style="position: absolute;"><font color="red"> <%=ServletUtility.getErrorMessage("gender", request)%></font></td>
				</tr>
        <tr>
          <th align="left" class="p1">MobileNo<span style="color:red">*</span></th>
    <td><input type="text" name="mobileNo" placeholder="Enter MobileNo" maxlength="10" size="40" class="p2" value="<%=DataUtility.getStringData(bean.getMobileNo()) %>"></td>
   <td style="position: absolute;"> <font color="red"><%=ServletUtility.getErrorMessage("mobileNo", request) %></font></td>
    </tr>
    <tr>
